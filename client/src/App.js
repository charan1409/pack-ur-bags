...
function App() {
  ...
  const Cultural = [{ id: 1, photo: cultural_photo1, to: "Amritsar: The Golden City", details: "Amritsar is undoubtedly the heart of the Sikh culture in the country where Golden temple is located.Amritsar has many gurudwaras, museums and cultural places that make it one of the best places to experience the Sikh culture." },
  { id: 2, photo: cultural_photo2, to: "Hampi: Ancient Kingdom Of Vijaynagar", details: "Hampi is a UNESCO world heritage site situated at the Northern part of Karnataka.This place is famous for Virupaksha temple and holding the ruins of the ancient kingdom of Vijaynagar." },
  { id: 3, photo: cultural_photo3, to: "Lucknow: The City Of The Nawabs", details: "With an architecture that is heavily influenced by the Mughals, the Delhi Sultanate, the Nawabs of Awadh and the British, you can imagine how magnificent the heritage and culture of Lucknow is." },
  { id: 4, photo: cultural_photo4, to: "Kolkata: The City Of Joy", details: "From the influence of the Nawabs of Bengal to the cultures set by the East India Company, the city of Kolkata has witnessed a tremendous cultural shift and emerged to have one of the most notable literary-rich crowd.Victoria Memorial, Howrah Bridge, Indian Museum, and St. Paul's Cathedral are the most prominent tourist places in Kolkata." },
  { id: 5, photo: cultural_photo5, to: "Kerala: God's Own Country", details: "The diverse culture of Kerala is a blend of Aryan & Dravidian cultures, with influences drawn time-and-again from other Indian & international places. Hinduism, Islam, and Christianity have contributed majorly to the architecture, the rituals & customs, the performing arts, and the festivals of Kerala." },
  { id: 6, photo: cultural_photo6, to: "Hyderabad: The City Of Nizams", details: "Hyderabad, established in 1591 was ruled by Sultans, Mughals, & Nizams before becoming a Princely State under the British Raj. The region was previously under the ancient kingdoms of Chalukyas and Kakatiyas. The city's architecture is richly influenced by all these cultures." }
  ];
